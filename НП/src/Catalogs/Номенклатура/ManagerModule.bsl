...
Процедура ОпределитьПараметрыЗагрузкиДанныхИзФайла(Параметры) Экспорт
	...
	ОписаниеТипаАртикул20 =  Новый ОписаниеТипов("Строка",,,, Новый КвалификаторыСтроки(20));
	Параметры.ТипДанныхКолонки.Вставить("Артикул", ОписаниеТипаАртикул20);
...
Процедура СопоставитьЗагружаемыеДанныеИзФайла(ЗагружаемыеДанные) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |		ПО (Номенклатура.Артикул = ДанныеДляСопоставления.Артикул)
	               |ГДЕ
	               ...
	               |		ПО ДанныеДляСопоставления.Артикул = СопоставленнаяНоменклатураПоАртикулу.Артикул
	               |ГДЕ
	               |	СопоставленнаяНоменклатураПоАртикулу.Артикул ЕСТЬ NULL 
	               |;
	               |
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               ...
	               |
	               |ВЫБРАТЬ
	               |	СопоставленнаяНоменклатураПоАртикулу.Ссылка,
